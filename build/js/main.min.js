...
},{"./modules/form-validate/form":3,"./modules/init-accordion":9,"./modules/modals/init-modals":10,"./modules/play-video.js":12,"./modules/slider.js":13,"./modules/tabs/init-tabs.js":14,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
},{"./../vendor/accordions":20}],10:[function(require,module,exports){
"use strict";
...
var videoContainer = document.querySelector('.about__media__videoplayer');
var playButton = videoContainer.querySelector('.play__button');
var poster = videoContainer.querySelector('.placeholder img');
var player = videoContainer.querySelector('.placeholder iframe');
...
exports.initSliderReviews = exports.initCoachesSlider = void 0;
...
var initCoachesSlider = function initCoachesSlider() {
  if (sliderCoaches) {
    new _swiper.default(sliderCoaches, {
      navigation: {
        nextEl: buttonNext,
        prevEl: buttonPrev
      },
